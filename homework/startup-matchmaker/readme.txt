...
RGBA color property for opacity 
image should be on browser side - no margin/padding etc.

last child and then not
:not
:lastchild
can be used to be target not the last child
